...
void setup() {
	...
	Motor::allocateTimer(0); //  for DC Motors
	ESP32PWM::allocateTimer(1); // for servos
 ...
 */
 ...
 //State machine: allows the bot to evaluate it's surroundings and react based off it's environment
void runStateMachine() {
 ...
 //update for the dashboard status on the web page
